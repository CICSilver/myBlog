...
class ViewFilterTest(unittest.TestCase):
    ...
    def test_normalizes_ip_address_for_filtering(self):
        self.assertEqual(normalize_ip_address(" 114.221.164.47 "), "114.221.164.47")
        self.assertEqual(normalize_ip_address("bad-ip"), "")
